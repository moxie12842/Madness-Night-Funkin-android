...
function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Instakill_Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'tiky_note'); --Change texture
    ...
    makeAnimatedLuaSprite('floorSpikes', 'FloorSpikes', 108, 325);
    ...
    makeAnimatedLuaSprite('Clone2', 'Clone', 483, 335);
