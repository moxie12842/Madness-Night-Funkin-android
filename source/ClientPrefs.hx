...
class ClientPrefs {
	...
	public static var disableGPUEff:Bool = false;
	public static var keSustains:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.disableGPUEff = disableGPUEff;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.disableGPUEff != null) {
			disableGPUEff = FlxG.save.data.disableGPUEff;
		}
