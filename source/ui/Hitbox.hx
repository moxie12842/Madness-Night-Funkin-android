...
class Hitbox extends FlxSpriteGroup
{
    ...
    public function new(type:HitboxType = DEFAULT)
    {
        ...
        switch (type){
            case KSP:
            {
                hitbox_hint.loadGraphic('assets/shared/images/hitbox/hitbox_pendulum_hint.png');

                frameshb = FlxAtlasFrames.fromSparrow('assets/shared/images/hitbox/hitbox_pendulum.png', 'assets/shared/images/hitbox/hitbox_pendulum.xml');
                sizex = 320;
