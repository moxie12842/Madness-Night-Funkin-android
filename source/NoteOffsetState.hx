...
class NoteOffsetState extends MusicBeatState
{
	...
	{
		var addNum:Int = 1;
		if(_virtualpad.buttonD.pressed) addNum = 10;
		...
		else
		{
			...
			{
				holdTime += elapsed;
				if(_virtualpad.buttonLeft.pressed) mult = -1;
			}

			if(_virtualpad.buttonLeft.justReleased || _virtualpad.buttonRight.justReleased) holdTime = 0;
